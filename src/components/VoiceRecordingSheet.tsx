  ...
  return (
    <>
      ...
      <div 
        ...
        style={{ zIndex: isOnboarding ? 390 : 60 }}
        onClick={cancelRecording}
      />
      
      {/* Sheet */}
      <div className="fixed bottom-0 left-0 right-0 bg-card rounded-t-3xl shadow-2xl animate-in slide-in-from-bottom duration-300" style={{ zIndex: isOnboarding ? 400 : 70 }}>
